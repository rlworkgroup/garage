...
The main modules use [Theano](http://deeplearning.net/software/theano/) as the underlying framework, and we have support for TensorFlow under [garage/tf](https://github.com/rlworkgroup/garage/tree/master/garage/tf).
