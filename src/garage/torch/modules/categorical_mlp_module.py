...
class Categorical_MLPBaseModule(nn.Module):
    """
    Categorical_MLPModel.
    ...
    def forward(self, inputs):
        ...
        explogits=torch.softmax(logits,dim=-1)
        dist=torch.distributions.Categorical(explogits)
...
class Categorical_MLPModule(Categorical_MLPBaseModule):
    """Categorical_MLPModule that mean and std share the same network."""
