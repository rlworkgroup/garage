...
class DiscreteCNNModule(nn.Module):
    ...
    A Q network that estimates Q values of discrete actions. It is constructed
    using a CNN followed by one or more fully-connected layers.

    Args:
        input_shape (tuple): Shape of the input. Based on 'NCHW' data format:
