...
These criteria may be satisfied in any order, but in practice your PR is unlikely to get attention from contributors until 1-3 are satisfied. Additionally, maintainer attention a scarce resource, so generally maintainers wait for a review from a non-maintainer contributor before reviewing your PR.
...
Do's and Don'ts avoiding accidental merge commits and other headaches:
