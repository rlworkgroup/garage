...
class ReacherHerEnv(MujocoEnv, Serializable):
    """Reacher Environment."""
    ...
    def __init__(self,
        ...
        super(ReacherHerEnv, self).__init__(*args, **kwargs)
    ...
    def step(self, action):
        ...
        reward = self.compute_reward(achieved_goal, goal, info=None)
    ...
    def reset(self, init_state=None):
        ...
        return super(ReacherHerEnv, self).reset(init_state)
    ...
    def action_space(self):
        ...
        if self._control_method == 'torque_control':
            return super(ReacherHerEnv, self).action_space()
        elif self._control_method == 'position_control':
            return Box(-100., 100., shape=(3, ), dtype=np.float32)
        else:
            raise NotImplementedError
