...
runuser -l avnishnarayan -c "cd garage && python docker_metaworld_run_gpu.py 'metaworld_launchers/mt1/mtsac_metaworld_mt1.py --env-name pick-place-v2'"
runuser -l avnishnarayan -c "cd garage/metaworld_launchers && python upload_folders.py mt1/pick-place-v2/round2/mtsac/v2 1200"
