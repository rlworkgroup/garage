...
runuser -l avnishnarayan -c "cd garage && python docker_metaworld_run_cpu.py 'metaworld_launchers/mt1/mttrpo_metaworld_mt1.py --entropy 0.005 --env-name pick-place-v2'"
runuser -l avnishnarayan -c "cd garage/metaworld_launchers && python upload_folders.py mt1/pick-place-v2/round2/mttrpo/v2 1200"
