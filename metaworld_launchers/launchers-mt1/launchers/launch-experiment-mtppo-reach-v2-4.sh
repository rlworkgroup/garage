...
runuser -l avnishnarayan -c "cd garage && python docker_metaworld_run_cpu.py 'metaworld_launchers/mt1/mtppo_metaworld_mt1.py --entropy 0.0001 --env-name reach-v2'"
runuser -l avnishnarayan -c "cd garage/metaworld_launchers && python upload_folders.py mt1/reach-v2/round2/mtppo/v2 1200"
