...
runuser -l avnishnarayan -c "cd garage && python docker_metaworld_run_gpu.py 'metaworld_launchers/ml1/pearl_metaworld_ml1.py --env-name reach-v2'"
runuser -l avnishnarayan -c "cd garage/metaworld_launchers && python upload_folders.py ml1/round3/reach-v2/pearl/v2 1200"
