...
runuser -l avnishnarayan -c "cd garage && python docker_metaworld_run_cpu.py 'metaworld_launchers/mt50/te_ppo_metaworld_mt50.py --entropy 0.0005'"
runuser -l avnishnarayan -c "cd garage/metaworld_launchers && python upload_folders.py mt50/round1/te/v2 1200"
