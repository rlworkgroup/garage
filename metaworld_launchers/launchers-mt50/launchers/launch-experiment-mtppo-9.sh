...
runuser -l avnishnarayan -c "cd garage && python docker_metaworld_run_cpu.py 'metaworld_launchers/mt50/mtppo_metaworld_mt50.py --entropy 0.0001'"
runuser -l avnishnarayan -c "cd garage/metaworld_launchers && python upload_folders.py mt50/round1/mtppo/v2 1200"
