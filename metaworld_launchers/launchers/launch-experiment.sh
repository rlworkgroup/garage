...
runuser -l haydenshively -c "cd garage && python docker_metaworld_run_cpu.py 'metaworld_launchers/single_task_launchers/ppo_metaworld.py --env-name plate-slide-back-v2'"
runuser -l haydenshively -c "cd garage/metaworld_launchers && python upload_folders.py ppo_round2 1200"
