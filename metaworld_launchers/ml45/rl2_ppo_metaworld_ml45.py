...
def rl2_ppo_metaworld_ml45(ctxt, seed, entropy_coefficient=5e-6, meta_batch_size=25, n_epochs=4000,
                           episode_per_task=10):
    ...
    with TFTrainer(snapshot_config=ctxt) as trainer:
        ml45 = metaworld.ML45()
        tasks = MetaWorldTaskSampler(ml45, 'train', lambda env, _: RL2Env(normalize(env, normalize_reward=True)))
