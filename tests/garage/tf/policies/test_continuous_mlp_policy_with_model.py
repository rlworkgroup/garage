...
class TestContinuousMLPPolicyWithModel(TfGraphTestCase):
    def setUp(self):
        ...
        self.policy = ContinuousMLPPolicyWithModel(env_spec=self.env.spec)
        self.env.reset()

    def test_continuous_mlp_policy_with_model_get_action(self):
    ...
    def test_continuous_mlp_policy_with_model_is_pickleable(self):
