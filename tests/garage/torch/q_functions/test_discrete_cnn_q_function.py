...
class TestDiscreteCNNQFunction:
    # yapf: disable
    @pytest.mark.parametrize('batch_size, hidden_channels, kernel_sizes, '
                             ...
                             [(1, (32, ), (1, ), (1, )),
                              ...
                              (22, (32, 64), (3, 3), (1, 1))])
    # yapf: enable
    def test_forward(self, batch_size, hidden_channels, kernel_sizes, strides):
    ...
    @pytest.mark.parametrize('batch_size, hidden_channels, '
                             ...
                             [(1, (32, ), (1, ), (1, )),
                              (15, (32, 64), (1, 1), (1, 1))])
    # yapf: enable
    def test_is_pickleable(self, batch_size, hidden_channels, kernel_sizes,
                           strides):
        env_spec = GymEnv(DummyBoxEnv(obs_dim=(3, 10, 10))).spec
        obs_dim = env_spec.observation_space.shape
