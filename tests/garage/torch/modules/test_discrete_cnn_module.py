...
class TestDiscreteCNNModule:
    ...
    def setup_method(self):
        ...
        self.in_channel = 3
        self.input_shape = (self.batch_size, self.in_channel,
    ...
    def test_output_values(self, output_dim, kernel_sizes, hidden_channels,
                           strides, paddings):
        ...
        """
        obs = torch.rand(self.input_shape)

        module = DiscreteCNNModule(input_shape=self.input_shape,
    ...
    @pytest.mark.parametrize(
        'output_dim, hidden_channels, kernel_sizes, strides',
        [(1, (32, ), (1, ), (1, )), (5, (32, ), (3, ), (1, )),
         (2, (32, ), (3, ), (1, )), (3, (32, 64), (1, 1), (1, 1)),
         (4, (32, 64), (3, 3), (1, 1))])
    def test_is_pickleable(self, output_dim, hidden_channels, kernel_sizes,
        ...
        """
        input_a = torch.ones(self.input_shape)

        model = DiscreteCNNModule(input_shape=self.input_shape,
                                  output_dim=output_dim,
                                  hidden_channels=hidden_channels,
                                  kernel_sizes=kernel_sizes,
