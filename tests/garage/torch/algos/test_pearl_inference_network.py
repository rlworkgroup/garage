...
"""This is a script to test the PEARLInferenceNetwork module."""
...
class TestPEARLInferenceNetwork:
    """Test for PEARLInferenceNetwork."""
    # yapf: disable
    ...
    def test_module(self, reward_dim, latent_dim, hidden_sizes, updates):
        ...
        module.sample_z()
        assert torch.all(
            torch.eq(torch.Tensor(module.z.shape),
        ...
        # current implementation of policy does not work because of fixed
        # input_dim
        """
